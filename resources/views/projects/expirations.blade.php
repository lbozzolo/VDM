        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4>Vencimientos</h4>
                    <button type="button" id="add-expiration-button" class="btn btn-sm btn-outline-primary mt-3">+ Agregar vencimiento</button>

                    @include('projects.partials.vencimientos')
